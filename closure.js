...
var PhoneFormat = {
    ...
    countryForE164Number: function(phone) {
        ...
        */
        try {
            var thePhone = this.cleanPhone(phone);
            var phoneUtil = i18n.phonenumbers.PhoneNumberUtil.getInstance();
            var number = phoneUtil.parseAndKeepRawInput(thePhone);
    ...
    // -------------------------------------------------------------------------
    formatNumberForMobileDialing: function(country, phone) {
        /*
        ...
        */
        ...
        try {
            var thePhone = this.cleanPhone(phone);
            var phoneUtil = i18n.phonenumbers.PhoneNumberUtil.getInstance();
            var number = phoneUtil.parseAndKeepRawInput(thePhone, country);
            var output = new goog.string.StringBuffer();
        ...
        */
        ...
        try {
            ...
            for (var i = 0; i < thePhone.length; ++i) {
                var inputChar = thePhone.charAt(i);
